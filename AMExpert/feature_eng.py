...
print("shape of the test data_first",test_data.shape)
print("shape of the train_data_first",train_data.shape)

train_data['tag_col'] = "Train"
test_data["tag_col"] = "Test"
merged_data = pd.concat([train_data,test_data],sort=False)

print("shape of the test data_first",merged_data.shape)
...
# merged_data = merged_data.join(one_hot,axis=0)
merged_data = pd.concat([merged_data,one_hot],axis = 1)
print("shape of the merge data_kast",merged_data.shape)
print(merged_data.columns)
print(merged_data.dtypes)
...
print("shape of the test data_last",test_data.shape)
